...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    console.log("SERVICE KEY", import.meta.env.VITE_APP_EMAILJS_SERVICE_ID);
    console.log("TEMPLAT KEY", import.meta.env.VITE_APP_EMAILJS_TEMPLATE_ID);
  ...
  return (
    <div className="xl:mt-12 flex xl:flex-row flex-col-reverse flex gap-10 overflow-hidden">
      ...
      <motion.div 
        variants={slideIn('right', 'easnInOut', 0.2, 1)}
